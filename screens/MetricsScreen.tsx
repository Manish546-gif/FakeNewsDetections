    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>AI Performance & Analysis insights</Text>
        </View>
        ...
        <View style={styles.statsGrid}>
           ...
           <View style={styles.statBox}>
              ...
              <Text style={[styles.statValue, {color: '#4285F4'}]}>{stats.avgRisk}%</Text>
           </View>
        </View>

        <View style={styles.wideStat}>
           <View style={styles.chartBar}>
              <View style={[styles.progress, { width: `${(stats.fake / (stats.total || 1)) * 100}%`, backgroundColor: '#FF4757' }]} />
           </View>
